...
void main()
{
	...
	// create a factory, that an array of shapes, that
	// knows nothing about CCircles and CPoints will
	// use to create objects while reading them from file
	CMyShapeFactory factory;
